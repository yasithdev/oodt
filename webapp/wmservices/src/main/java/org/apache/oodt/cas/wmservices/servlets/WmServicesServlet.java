...
public class WmServicesServlet extends CXFNonSpringJaxrsServlet {
  ...
  private static final Logger LOG = LoggerFactory.getLogger(WmServicesServlet.class.getName());
  ...
  public void init(ServletConfig configuration) throws ServletException {
    ...
    try {
      ...
      LOG.error("Encountered a malformed URL for the workflow manager.", e);
  ...
  public void destroy() {
    if (client != null) {
      try {
        ...
        LOG.error(String.format("Unable to close WM Client: %s", e.getMessage()), e);
      }
    }

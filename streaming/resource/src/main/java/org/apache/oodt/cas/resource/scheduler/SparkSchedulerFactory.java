...
public class SparkSchedulerFactory implements SchedulerFactory {
	...
	private static final Logger LOG = LoggerFactory.getLogger(SparkSchedulerFactory.class.getName());
	...
	public SparkSchedulerFactory() {
		...
		LOG.info("Using job-queue: "+jobQueueClassStr+ " with: "+SparkScheduler.class.getName());

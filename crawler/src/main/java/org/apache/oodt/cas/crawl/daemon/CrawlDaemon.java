...
public class CrawlDaemon {
    ...
    /* our log stream */
    private static Logger LOG = LoggerFactory.getLogger(CrawlDaemon.class.getName());
    ...
    public void startCrawling() {
        ...
        LOG.info("Crawl Daemon started by "
        ...
        while (running) {
            ...
            LOG.info("Sleeping for: [" + waitInterval + "] seconds");
            // take a nap
            try {
        ...
        LOG.info("Total time spent crawling: ["
                + (this.milisCrawling / DOUBLE) + "] seconds");
        LOG.info("Average Crawl Time: ["
